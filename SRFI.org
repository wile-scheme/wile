...
Wile implements 20 of 268 SRFIs. This document tracks the status of
...
|   87 | => in case clauses                             | Not supported in Wile |
...
|   48 | Intermediate Format Strings               | Extends SRFI 28; moderate effort     |
|   51 | Handling rest list                        | Simple; low demand                   |
|   61 | More general cond clause                  | Needs ==>= in =cond= (unsupported)   |
...
|  117 | Queues based on lists                     | Simple; low demand                   |
...
|  145 | Assumptions                               | Trivial macro; low priority          |
...
|  156 | Syntactic combiners for binary predicates | Pure Scheme macro; trivial           |
|  158 | Generators and Accumulators               | Large API; moderate effort           |
|  162 | Comparators sublibrary                    | Subset of SRFI 128                   |
|  175 | ASCII character library                   | Pure Scheme; trivial                 |
|  188 | Splicing binding constructs               | Expander change needed               |
|  189 | Maybe and Either                          | Pure Scheme; moderate effort         |
|  190 | Coroutine Generators                      | Needs =call/cc=; moderate effort     |
|  195 | Multiple-value boxes                      | Simple; low demand                   |
...
|  210 | Multiple Values procedures                | Pure Scheme; moderate effort         |
|  214 | Flexvectors                               | Pure Scheme; moderate effort         |
|  219 | Define higher-order lambda                | Simple macro; low priority           |
|  221 | Generator/accumulator sub-library         | Depends on SRFI 158                  |
|  222 | Compound Objects                          | Pure Scheme; low priority            |
|  223 | Generalized binary search                 | Pure Scheme; trivial                 |
|  225 | Dictionaries                              | Pure Scheme; moderate effort         |
|  226 | Control Features                          | Pure Scheme; low priority            |
|  228 | Composing Comparators                     | Builds on SRFI 128; easy             |
|  232 | Flexible curried procedures               | Pure Scheme macro; low priority      |
|  234 | Topological Sorting                       | Pure Scheme; easy                    |
|  235 | Combinators                               | Pure Scheme; trivial                 |
